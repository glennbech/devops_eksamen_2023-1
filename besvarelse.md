...
* task2.yml, for oppgave 3, anbefaler å gjøre med engang, ellers kan actions misslykes
  * Bytte ut env verdiene på prefix og email
  * email for alarm i cloudwatch
  * prefix for navn i terraform
